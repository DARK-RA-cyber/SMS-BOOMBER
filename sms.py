import os
print("\033[1;92mDARK-RA (ROBOT) SYSTEM INSTALL. . . . \033[1;30m")
os.system("pkg install espeak")
print("\033[1;92mROBOT INSTALL COMPLETE \033[1;30m")
os.system('espeak -a 300 "Robot install complete"')
print("\033[1;92mUPDATE CHECKING BOSS DARK-RA KING DARK-RA\033[1;30m")
os.system('espeak -a 300 "update checking boss DARK-RAcyber king DARK-RA"')
os.system("git pull")
...
\033[1;94m[+]===============================================================[+]
\033[1;94m[+]\033[1;32m               CREATED BY   :  DARK-RA                     \033[1;94m[+]
\033[1;94m[+]\033[1;32m               ON GITHUB    :  DARK-RA-cyber                      \033[1;94m[+]
...
\033[1;94m[+]\033[1;32m               FACEBOOK     :  MUHAMMAD RONI AKANDO                       \033[1;94m[+]
\033[1;94m[+]===============================================================[+]
...
while amount>ses:
  ...
  if sent1.status_code==200:
    ses+=1
    print(f"\n{ses}  \033[38;5;46m🦋⃟DARK-RA✮⃝  𝐈𝐍𝄟⃝💥  SMS WAS SENT🐼")
  else:
    pass
  ...
  if sent2.status_code==200:
    ses+=1
    print(f"\n{ses} \033[38;5;46m🦋⃟DAR-RA✮⃝  𝐈𝐍𝄟⃝💥  SMS WAS SENT🐼")
  else:
    pass
